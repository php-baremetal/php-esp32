/* ST77916 panel init sequences (two silicon variants, selected at runtime by reading register 0x04).
 * Vendor tables from the Espressif esp_lcd_st77916 reference; kept verbatim. */
#pragma once
