# Optional-extension wiring for PHP 8.5.10. Included after idf_component_register
...
if(PHP_EXT_MBSTRING)
    ...
    # The legacy CJK codecs live in mbfilter_cjk.c -- ~740 KB. Make them optional: with
    # PHP_EXT_MBSTRING_NO_CJK it is dropped and the 0003 patch removes the CJK registry
    # entries (guarded by MBSTRING_NO_CJK) so nothing references the missing symbols. (In
    # PHP 8.4 the old mbfilter_utf8_mobile.c is gone; the mobile encodings moved into the
    # always-compiled mbfilter_utf8.c.)
...
if(PHP_EXT_OPCACHE)
    target_sources(${COMPONENT_LIB} PRIVATE
        ...
        ${PHP_SRC}/ext/opcache/zend_accelerator_api.c
...
# PHP 8.5: ext/uri is a built-in the core links against; always compiled (uriparser + lexbor URL).
include("${PHP_COMPONENT_DIR}/${PHP_VER_DIR}/uri.cmake")
...
if(PHP_EXT_WIFI)
    if(IDF_TARGET STREQUAL "esp32h2")
        message(FATAL_ERROR "PHP_EXT_WIFI needs a WiFi radio: the target '${IDF_TARGET}' has none. Use an ESP32 / ESP32-S3 / C-series board, or an ESP32-P4 with a WiFi companion over ESP-HOSTED.")
    endif()
