/*
 * ESP32-P4-Zero board support (a minimal ESP32-P4: no microSD slot, no wired network).
 *
 * This is the P4-Pico stripped further. It runs embedded-only -- the PHP source is packed
...
#define BOARD_NAME "ESP32-P4-Zero"  /* the specific board (identity for tooling) */
