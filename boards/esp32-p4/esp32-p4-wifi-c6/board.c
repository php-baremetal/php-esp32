/*
 * ESP32-P4-WIFI-C6 storage: a microSD on 4-bit SDMMC, powered by the chip's on-chip
...
/* microSD wiring on the ESP32-P4-WIFI-C6 (4-bit SDMMC), from the board schematic. */
